...
The first challenge was thinking about relationships between resources. How do resources connect? What fields are required? What's optional? 
...
I tested the API with Postman by walking through some possible user workflows. I asked myself, "Where would a developer start? What would they do next?" If I ran into an error, I had to determine whether it was user error or an actual bug that users could encounter. 
