...
Eventually. I need to write setup instructions for the API. If you're feeling adventure, feel free to download the source code and run the API in your own environment.
