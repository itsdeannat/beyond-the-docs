...
What if there was a CLI tool that could validate and improve OAS files?
...
As a technical writer, I spend most of my time focused on the documentation layer. That means thinking about what users need to know, how to present information clearly, and what's missing or confusing.

But I don't usually have to understand how the systems were built. 
...
* How do you help developers integrate their code with your platform?
...
* How do you design a good UX for a CLI?
