...
I initially built a protoype CLI called SmartDoc using Python and [Typer](https://typer.tiangolo.com/). SmartDoc used a large-language model (LLM) from OpenAI called GPT-5-mini to analyze OAS files and surface missing documentation. 
